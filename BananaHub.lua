...
local Window = OrionLib:MakeWindow({Name = "さま┊Matrix Hub : By Matrix Community", HidePremium = false, IntroText = "MATRIX HUB : BLOX FRUITS V1", SaveConfig = true, ConfigFolder = "MatrixHubConfigs"})


OrionLib:MakeNotification({
	Name = "さま┊By Matrix Community",
	Content = "さま┊Matrix Hub Loading...",
